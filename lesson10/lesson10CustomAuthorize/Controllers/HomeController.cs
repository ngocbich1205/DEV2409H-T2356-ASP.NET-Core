    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Login(Login model)
        {
            if (!ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Tài khoản không hợp lệ"); return View(model);
                }
                ...
                HttpContext.SignInAsync("DevSecuritySchema", priciple); return RedirectToAction("Index", "Admin");
